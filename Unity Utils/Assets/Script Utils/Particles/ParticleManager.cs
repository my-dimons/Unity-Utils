...
namespace UnityUtils.ScriptUtils.Particles {
    public static class ParticleManager
    {
        ...
        private static void SetParticleSystemColor(GameObject particleSystem, Color color)
        {
            var main = GetParticleSystem(particleSystem).main;
            main.startColor = color;
        }

        private static void SetParticleSystemGradientColor(GameObject particleSystem, Gradient gradient)
        {
            var main = GetParticleSystem(particleSystem).main;
        ...
        /// </summary>
        private static ParticleSystem GetParticleSystem(GameObject obj)
        {
